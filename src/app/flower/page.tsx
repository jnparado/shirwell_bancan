  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-10 text-pretty">
      <Link
        ...
        className="group relative mb-8 block aspect-[3/4] w-full max-w-xs cursor-pointer overflow-hidden rounded-2xl border border-emerald-500/25 bg-black/30 shadow-[0_0_48px_rgba(16,185,129,0.12)] transition hover:border-emerald-400/45 hover:shadow-[0_0_64px_rgba(16,185,129,0.18)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400 sm:mx-auto sm:max-w-sm"
